 ...
 */
	Configure::write('Session', array(
		'defaults' => 'php', 'timeout' => 60 * 24 * 30
	));

/**
 * A random string used in security hashing methods.
 */
	Configure::write('Security.salt', 'DYhG93b0qyJfIxfvtwsfbshrtgvvw54c5g42g7jVobehUubWwvniR2G0FgaC9mi');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '76859309657453544568734647689589678354642496749683645');
